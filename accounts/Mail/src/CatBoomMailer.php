...
class CatBoomMailer{
    ...
    public function setLanguage($langcode = 'en', $lang_path = '')
    {
        ...
        $foundlang = true;
        $lang_file = $lang_path . 'catboomailer.lang-' . $langcode . '.php';
        if ('en' !== $langcode) {
        ...
        $this->language = $CATBOOMMAILER_LANG;
    ...
    public function createHeader()
    {
        ...
        if ('' === $this->XMailer) {
            $result .= $this->headerLine(
                'X-Mailer',
                'CatBoomMailer ' . self::VERSION . ' (https://github.com/Catover203/Catover203-function)'
            );
        } else {
    ...
    protected function lang($key)
    {
        ...
        if (array_key_exists($key, $this->language)) {
            if ('smtp_connect_failed' === $key) {
                return $this->language[$key] . ' Smaill error';
            }
        ...
        if (array_key_exists(2, $images)) {
            ...
            foreach ($images[2] as $imgindex => $url) {
                ...
                if (preg_match('#^data:(image/(?:jpe?g|gif|png));?(base64)?,(.+)#', $url, $match)) {
                    ...
                    $cid = substr(hash('sha256', $data), 0, 32) . '@catboommailer.0';
                ...
                if (
                    ...
                    $cid = substr(hash('sha256', $url), 0, 32) . '@catboommailer.0';
                    if (strlen($basedir) > 1 && '/' !== substr($basedir, -1)) {
                        $basedir .= '/';
                    }
